...
export class Icon {
  constructor() {}
  @Input() name!: 'sun' | 'cloud' | 'snowflake' | 'stars' | 'check' | 'facebook' | 'google'| 'arrow-bar-up' | 'check-circle' | 'edit' | 'save' | 'hanger' | 'upload' | 'heart' | 'tops' | 'bottoms' | 'shoes' | 'accessories' | 'dresses' | 'outerwear';
